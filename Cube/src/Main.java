...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        boolean fuckaround = true;

        if(fuckaround){
            System.out.println("It seams like we fucking around tonight");
            System.out.println("so lets get to the finding out");
            Main_Test mainTest = new Main_Test("f");
        }else {
