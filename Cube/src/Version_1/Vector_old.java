...
public class Vector_old {
    ...
    private Coordinates_old startPoint;
     ...
     */
    public Vector_old(){
        startPoint = new Coordinates_old();
     ...
     */
    public Vector_old(Coordinates_old cord, int xDir, int yDir, int zDir){

        try{
            setStartPoint(cord);
        }catch (NullPointerException np){
            setStartPoint(new Coordinates_old());
        }
     ...
     */
    public Vector_old(int xCord, int yCord, int zCord, int xDir, int yDir, int zDir){

        setStartPoint(new Coordinates_old(xCord, yCord, zCord));
     ...
     */
    public Coordinates_old getStartPoint() {
        return startPoint;
    }
     ...
     */
    public void setStartPoint(Coordinates_old startPoint) throws NullPointerException {
        try{
    ...
    public boolean equals(Object obj) {
        ...
        if(obj.getClass().equals(Vector_old.class)){
            if(((Vector_old) obj).startPoint.equals(startPoint) &&
                ((Vector_old) obj).xDirection == xDirection &&
                ((Vector_old) obj).yDirection == yDirection &&
                ((Vector_old) obj).zDirection == zDirection){
                return true;
            }
        }
        return false;
